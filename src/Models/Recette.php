...
class Recette {
    ...
    public function add($titre, $description, $auteur, $type_plat, $image, $isApproved) {
        $query = "INSERT INTO recettes (titre, description, auteur, type_plat, image, isApproved) VALUES (:titre, :description, :auteur, :type_plat, :image, :isApproved)";
        $stmt = $this->conn->prepare($query);
